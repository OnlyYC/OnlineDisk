...
public class ConnectionPool {
	...
	private int initialConnecions=10;// 连接池的初始大小
	...
	public int getInitialConnecions() {
		return initialConnecions;
	}
	public void setInitialConnecions(int initialConnecions) {
		this.initialConnecions = initialConnecions;
	}
	...
	public synchronized void createPool() throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		createConnections(this.initialConnecions);
	...
	private boolean testConnection(Connection conn) {
		...
		if(testTable.equals("")){
			...
			stat.execute("select count(*) from "+testTable);
		}
			} catch (SQLException e) {
